...
/**
 * Project information for client reports and documentation
 */
export interface ProjectInfo {
  /** Project name or identifier */
  project_name?: string;

  /** Section or element name within the project */
  section_name?: string;
  ...
  /** Project reference or number */
  project_reference?: string;

  /** Engineer or designer name */
