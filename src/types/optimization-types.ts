...
export type OptimisationResult = {
  genetic: {
    ...
    rise_to_bolts?: number // mm - Worst-case position (bottom-of-slot) for structural calculations
    rise_to_bolts_display?: number // mm - Display value showing middle-of-slot position (15mm above calculation value)
