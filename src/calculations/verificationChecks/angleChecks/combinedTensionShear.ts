 ...
 * Uses two alternative formulas:
 * 1. (N_Ed/N_Rd,i)^1.5 + (V_Ed/V_Rd,i)^1.5 <= 1
 * 2. (N_Ed/N_Rd,i) + (V_Ed/V_Rd,i) <= 1.2
 * 
...
export function verifyCombinedTensionShear(
    ...
    // Check passes if either formula is satisfied
    const passes = U_combined_1 <= 1 || U_combined_2 <= 1.2;
