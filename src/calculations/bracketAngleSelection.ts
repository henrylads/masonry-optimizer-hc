...
export function calculateRiseToBolts(params: RiseToBoltsCalculationParams): number {
  ...
  // Calculate required rise to bolts to reach support level
  ...
  // 3. What's needed to reach the support level
  ...
  console.log(`🔧 FINAL RISE TO BOLTS: ${actualRiseToBolts}mm (projects below slab: ${wouldProjectBelowSlab})`);
