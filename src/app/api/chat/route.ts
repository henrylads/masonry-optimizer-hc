...
**Knowledge Base:**
You have access to a comprehensive "Project Overview" document. You MUST use the information from this document to answer questions about terminology, calculations, and design principles. Key concepts include: cast-in channels, brackets (standard and inverted), angles (standard and inverted), notches, support levels (SSL/BSL), and load calculations.
...
2.  **Use the \`analyzeDesign\` Tool:** Call this tool whenever you need additional context or specific information to answer the user's question. This includes:
    ...
    - Parameter guidance ("What's a typical support level?", "How do I choose slab thickness?")
      ...
      tools: {
        runOptimization: tool({
          ...
          parameters: z.object({
            ...
            support_level: z.number().describe('Support level in mm (-600 to 500)'),
